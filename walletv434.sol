...
contract AdvancedSmartWallet is IERC1271, Initializable, UUPSUpgradeable, ReentrancyGuard {
    ...
    function emergencyRevokeApproval(
        ...
        // Create the message hash with chain ID to prevent cross-chain replay
        ...
        // Use standard Ethereum signed message format
        ...
        require(owners[signer], "AdvancedSmartWallet: invalid owner signature");
        ...
        require(success, "AdvancedSmartWallet: ERC20 revoke failed");

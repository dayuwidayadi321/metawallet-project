    ...
    IERC1271Upgradeable
{
    ...
    string public constant UPGRADE_INTERFACE_VERSION = "1.0.0";
        ...
        returns (bytes4)
    {
        ...
        if (isOwner) {
            // Emitting events in a view function is not recommended as it would require changing to non-view
            // In production, consider alternative approaches for logging
        ...
        nonReentrant
    {
        ...
        require(keccak256(bytes(version)) == keccak256(bytes(UPGRADE_INTERFACE_VERSION)), "Version mismatch");

...
contract MetaWalletV9 {
    ...
    bytes32 public constant META_DEPLOY_TYPEHASH = keccak256("MetaDeploy(address user,uint256 nonce)");
    bytes32 public constant DOMAIN_TYPEHASH = keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)");
    bytes32 public immutable DOMAIN_SEPARATOR;

    string public constant NAME = "MetaWallet";
    string public constant VERSION = "9"; // Upgraded version
    ...
    constructor() {
        ...
        userWalletBytecode = type(UserWalletV9).creationCode;
    }

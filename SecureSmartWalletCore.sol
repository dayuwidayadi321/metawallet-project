...
/**
 * @title SecureSmartWalletCore v5.3 - Ultimate Inheritable EIP-4337 Smart Wallet
 * @author DFXC IndonesiaSecurity Web3 Project - Dev. DayuWidayadi
 * @notice Core v5.3 with Enhanced Inheritance Support & Security Upgrades
 * @dev [NEW] Inheritance-friendly architecture with:
...
abstract contract SecureSmartWalletCore is Initializable, EIP712 {
    ...
    constructor(IEntryPoint _entryPoint, address _gasOracle) 
        EIP712("SecureSmartWalletCore", "5.3") 
    {

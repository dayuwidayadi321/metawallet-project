...
import "./CoreV55.sol"; // <-- IMPORT PARENT CONTRACT

/**
 * @title BundlerWallet - CoreV55 Child with UserOp Bundling
 * @dev Inherits CoreV55 and adds batch transaction support
 */
contract BundlerWallet is CoreV55 {
    ...
    // Override validateUserOp for bundle support
...
contract CoreV55Factory {
    ...
    address public immutable bundlerWalletImplementation; // <-- NEW
    ...
    constructor(
        ...
        address _bundlerImpl, // <-- NEW
        IEntryPoint _entryPoint
    ) {
        coreV55Implementation = _coreV55Impl;
        bundlerWalletImplementation = _bundlerImpl; // <-- NEW
    ...
    function createBundlerWallet(
        ...
        ERC1967Proxy proxy = new ERC1967Proxy(
            bundlerWalletImplementation, // <-- Use Bundler impl
    ...
    function registerImplementation(
        ...
        if (isBundler) {
            bundlerWalletImplementation = newImplementation;
        } else {
            coreV55Implementation = newImplementation;
        }

...
contract BundlerWallet is CoreV55 {
    ...
    {
        _disableInitializers(); // Tambahkan ini untuk keamanan
    }
    
    // Fungsi initialize diperbarui
    function initializeBundler(
        ...
        // Panggil fungsi initialize parent
        __CoreV55_init(
            owners,
            guardian,
            threshold,
...
contract CoreV55Factory {
    ...
    function createBundlerWallet(
        ...
        ERC1967Proxy proxy = new ERC1967Proxy(
            ...
            abi.encodeWithSelector(
                bytes4(keccak256("__CoreV55_init(address[],address,uint64,uint64,address,uint16[],bytes[])")),
                owners,
                guardian,
                threshold,
                recoveryCooldown,

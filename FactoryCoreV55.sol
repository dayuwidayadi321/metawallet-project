...
contract BundlerWallet is CoreV55 {
    ...
    // Fungsi internal untuk inisialisasi UserOps
    function _initializeForUserOp(IEntryPoint _entryPoint, address _paymaster) internal {
        // Lakukan inisialisasi yang diperlukan untuk UserOps
        // Contoh: set entry point dan paymaster

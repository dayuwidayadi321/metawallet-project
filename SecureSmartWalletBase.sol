    ...
    ReentrancyGuardUpgradeable 
{
    ...
    function updateGuardians(
        ...
        for (uint256 i = 0; i < newGuardians.length; ) {
            ...
            require(!tempGuardianSet[guardian], "Duplicate in batch");
            tempGuardianSet[guardian] = true;
    ...
    function _isActiveGuardian(address guardian) internal view returns (bool) {
        return guardianConfig.isGuardian[guardian]; // Single source of truth
    }
    ...
    function scheduleUpgrade(address newImplementation) external onlyOwner {
        ...
        // Storage compatibility check (NEW)
        ERC1967Utils.checkStorageCompatibility(
            ERC1967Utils.getImplementation(),
            newImplementation
        );
    
        // Existing UUPS compliance check
        ...
        require(success, "Must be UUPS compliant");
    
        // Existing code hash verification
        bytes32 codeHash;
        assembly {
    ...
    function executeUpgrade() external onlyOwner {
        ...
        emit UpgradeVerified(newImplementation, true);
    }

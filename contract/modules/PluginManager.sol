...
abstract contract PluginManager is EIP712Upgradeable, ReentrancyGuardUpgradeable {
     ...
     * @param selectors Array of function selectors to expose
     * @param initData Calldata for plugin initialization
     * @param whitelist Whether to whitelist the plugin
     */
    function installPlugin(
        ...
        require(selectors.length <= MAX_SELECTORS_PER_PLUGIN, "Too many selectors");
     ...
     * @param plugin Address of the plugin to uninstall
     */
     ...
     * @param uninstallNonce Unique nonce for this operation
     ...
     * @param oldPlugin Address of current plugin
     * @param newPlugin Address of new plugin
     * @param migrationData Calldata for migration
     */

...
abstract contract SecurityManager is EIP712Upgradeable, ReentrancyGuardUpgradeable {
    ...
    function __SecurityManager_init() internal onlyInitializing {
        ...
        returns (bool needsRotation) 
    {
        ...
        return inactivePeriod > 180 days;
    }

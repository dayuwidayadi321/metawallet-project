 ...
 * @author DFXC Indonesia Security Web3 Project
...
contract SecureSmartWallet is IERC1271, Initializable, UUPSUpgradeable, ReentrancyGuard {
    ...
    string public constant DESCRIPTION = "EIP-4337 Smart Wallet with Emergency Recovery (by DFXC Indonesia Security Web3 Project)";
    ...
    function ownerInstantRevoke(
        ...
        bytes32 hash = keccak256(abi.encode(token, spender, deadline)).toEthSignedMessageHash();
        address signer = hash.recover(signature);

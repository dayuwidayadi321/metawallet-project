...
import "@openzeppelin/contracts-upgradeable/token/ERC20/extensions/ERC20PermitUpgradeable.sol"; // Import ERC20PermitUpgradeable

contract SafeHaven is ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable, ERC20PermitUpgradeable { // Tambahkan ERC20PermitUpgradeable
    ...
    // Versi kontrak
    string public constant CONTRACT_VERSION = "8.1"; // Diperbarui ke versi 8.1
    ...
    function initialize(address ownerAddress, uint256 initialSupply) public initializer {
        ...
        __ERC20Permit_init("BURN"); // Inisialisasi ERC20Permit dengan nama token. Perhatikan bahwa nama di sini harus sama dengan yang di __ERC20_init.

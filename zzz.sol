    ...
    IERC1271Upgradeable
{
    ...
    function createEmergencyRequest(
        ...
        require(tokens.length <= 50, "SecureSmartWallet: too many tokens");
    
        for (uint256 i = 0; i < tokens.length; i++) {
            require(tokens[i] != address(0), "SecureSmartWallet: invalid token");
            require(maliciousContracts[i] != address(0), "SecureSmartWallet: invalid contract");
            require(!isBlacklisted[maliciousContracts[i]], "SecureSmartWallet: already blacklisted");
        }
...
DeclarationError: Function with same name and parameter types defined twice.
   --> github/dayuwidayadi321/metawallet-project/zzz.sol:103:5:
    |
103 |     function createEmergencyRequest(
    |     ^ (Relevant source part starts here and spans across multiple lines).
Note: Other declaration is here:
   --> github/dayuwidayadi321/metawallet-project/zzz.sol:651:5:
    |
651 |     function createEmergencyRequest(
    |     ^ (Relevant source part starts here and spans across multiple lines).

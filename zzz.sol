    ...
    IERC1271Upgradeable
{
    ...
    // ========== UUPS Upgrade Functions ========== //
     function scheduleUpgrade(address newImplementation) external onlyOwner {
         ...
         // Verifikasi minimal bahwa kontrak baru mendukung antarmuka yang diperlukan
     ...
     function executeUpgrade() external onlyOwner {
         ...
         // Reset state sebelum upgrade untuk mencegah reentrancy

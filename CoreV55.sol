...
abstract contract CoreV55 is Initializable, UUPSUpgradeable, EIP712, ReentrancyGuard {
    ...
    function _validatePlugin(address plugin, bytes4[] calldata selectors) internal view {
        ...
        require(
            !_containsBytes(code, hex"f0") && // CREATE
            !_containsBytes(code, hex"f5") && // CREATE2
            !_containsBytes(code, hex"ff"),   // SELFDESTRUCT
        ...
        whenNotLocked 
    {
        ...
        require(keccak256(bytes(version)) == keccak256(bytes("5.5")), "Version mismatch");
    ...
    function getOwners() external view returns (address[] memory) {
        EnumerableSet.AddressSet storage owners = _owners;

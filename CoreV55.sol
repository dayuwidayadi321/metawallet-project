...
/**
 * @title Core v5.5 (BETA VERSION) - Ultimate Inheritable EIP-4337 Smart Wallet
...
abstract contract CoreV55 is Initializable, EIP712, ReentrancyGuard {
    ...
    // Custom error untuk revert yang lebih jelas
    ...
    function emergencyLock(bytes calldata guardianSignature) external virtual {
        bytes32 lockHash = _hashTypedDataV4(keccak256(abi.encode(
            ...
            block.timestamp + 1 hours // Deadline harus diperiksa
        )));
    
        // Pastikan signature belum kadaluarsa

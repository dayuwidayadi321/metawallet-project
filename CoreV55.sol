...
abstract contract CoreV55 is Initializable, UUPSUpgradeable, EIP712, ReentrancyGuard {
        ...
        returns (bool) 
    {
        return 
            ...
            interfaceId == type(ICoreV55).interfaceId;
    }    
    ...
    function initiateRecovery(
        ...
        bytes32 recoveryId = keccak256(abi.encodePacked(recoveryHash, block.chainid, address(this), _srcChainId);
        ...
        whenNotLocked 
    {
        ...
        require(newImpl.code.length > 0, "No code at implementation");
        require(newImpl != _getImplementation(), "Same implementation");
